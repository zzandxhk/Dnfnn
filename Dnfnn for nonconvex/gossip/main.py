...
ln2, = ax.plot(track_log_5, label='DGD', marker='o', markersize=6, markevery=80)
ln1, = ax.plot(track_log_3, label='EXTRA', marker='v', markersize=6, markevery=80)
ln3, = ax.plot(track_log_6, label='GT', marker='h', markersize=6, markevery=80)
ln4, = ax.plot(track_log_4, label='CGT-FR', marker='s', markersize=6, markevery=80)

plt.legend(handles=[ln1, ln2, ln3, ln4], loc='upper right')
plt.show()
